...
class AccountAttributesNestedStack(BaseNestedStack):
    def __init__(self, scope: Construct, id: str, rest_api_id: str, root_resource_id: str, **kwargs) -> None:
        ...
        ark_account_get_function_arn = get_imported_value(self.STACK_PREFIX + "ark-account-attribute-get-function-arn")

        lambda_function = get_lambda_function_from_arn(self, "ark-account-attribute-get-function-arn", ark_account_get_function_arn)
