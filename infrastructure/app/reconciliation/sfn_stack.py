...
class StepFunctionStack(BaseStack):
    def __init__(self, scope: Construct, id: str,
        ...
        sfn_definition = accounts_recon_task.next(ledgers_recon_task).next(je_lb_recon_task)
        ...
        # eventbridge_cron.add_target(cdk.aws_events_targets.SfnStateMachine(state_machine))
