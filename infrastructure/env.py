...
prod = {
    ...
    "EXPORT_BUCKET_NAME": "arkgl-export",
    "JOURNAL_ENTRIES_BULK_STATE_BUCKET_NAME": "arkgl-journal-entries-bulk-state",
    "SQS_RECOVERY_PROCESS": "ark-sqs-dr-recovery-process",
    "SQS_ACCOUNT_BULK_STATE_PROCESS": "ark-sqs-account-bulk-state-process",
    "SQS_ACCOUNT_BULK_STATE_PROCESS_DL": "ark-sqs-account-bulk-state-process-dead-letter",
    "SQS_LEDGER_BULK_STATE_PROCESS": "ark-sqs-ledger-bulk-state-process",
    "SQS_LEDGER_BULK_STATE_PROCESS_DL": "ark-sqs-ledger-bulk-state-process-dead-letter",
    "SQS_JOURNAL_ENTRY_BULK_STATE_PROCESS": "ark-sqs-journal-entry-bulk-state-process",
    "SQS_JOURNAL_ENTRY_BULK_STATE_PROCESS_DL": "ark-sqs-journal-entry-bulk-state-process-dead-letter",
