...
class PipelineFeedbackStack(BaseStack):
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        # Define the pipeline
        pipeline = codepipeline.Pipeline(self, 'ark-code-pipeline-feedback',
            pipeline_name=self.STACK_PREFIX + 'ark-code-pipeline-feedback',
        ...
        events.Rule(
            self,
            "ark-gl-pipeline-feedback-rule",
            description="Trigger notifications based on CodeCommit PullRequests for Feedback",
