...
from pipeline.standard_bucket import S3Construct
from iam_stack import IAMPipelineStack


class DefaultPipelineStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, config: object, **kwargs) -> None:
        ...
        repo = Repository.from_repository_name(self, 'ark-ledger', 'ark-ledger-pipeline-test')
