...
def insert(db:str, input:dict, region_name:str, secret_name:str, db_type:str = None) -> str:
...
def delete(db:str, id:str, region_name:str, secret_name:str, db_type:str = None) -> None:
...
def update(db:str, id:str, input:dict, region_name:str, secret_name:str, db_type:str = None) -> None: 
