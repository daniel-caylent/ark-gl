...
def get_query_insert(db:str, input:dict, region_name:str, secret_name:str, db_type:str = 'ro') -> tuple:
    query = """
    ...
    fund_entity_id = fund_entity.get_id(db, fund_entity_uuid, region_name, secret_name, 'ro')
    account_attribute_uuid = translated_input.get('account_attribute_id')
    account_attribute_id = account_attribute.get_id(db, account_attribute_uuid, region_name, secret_name, 'ro')
...
def insert(db:str, input:dict, region_name:str, secret_name:str, db_type:str = None) -> None:
    params = get_query_insert(db, input, region_name, secret_name, 'ro')
