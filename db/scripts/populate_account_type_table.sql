...
INSERT INTO ARKGL.account_attribute
(number, uuid, account_type, detail_type, created_at)
VALUES(4,UUID(), 'Income', 'Balance Sheet', CURRENT_TIMESTAMP);

INSERT INTO ARKGL.account_attribute
(number, uuid, account_type, detail_type, created_at)
VALUES(5,UUID(), 'Expense', 'Balance Sheet', CURRENT_TIMESTAMP);

INSERT INTO ARKGL.account_attribute
(number, uuid, account_type, detail_type, created_at)
VALUES(6,UUID(), 'Gain/Loss', 'Balance Sheet', CURRENT_TIMESTAMP);